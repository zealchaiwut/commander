---
name: estimator
description: Issue Estimator — reads a GitHub ticket and produces structured sizing metadata (size, hours, confidence, files affected, dependencies, risk flags). Usage: /estimate <issue-url>
