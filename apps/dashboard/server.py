...
app.include_router(sprint_analytics_router)
...
# GET /api/sprints/{sprint_label}/estimate-summary moved to routers/sprint_analytics.py (issue #1252)
...
# GET /api/sprints/{sprint_label}/estimate moved to routers/sprint_analytics.py (issue #1252)
# GET /api/estimates/batch moved to routers/sprint_analytics.py (issue #1252)
...
# GET /api/sprints/{sprint_label}/outcome moved to routers/sprint_analytics.py (issue #1252)
# GET /api/sprints/{sprint_label}/estimate-vs-actual moved to routers/sprint_analytics.py (issue #1252)
# GET /api/calibration moved to routers/sprint_analytics.py (issue #1252)
...
# GET /api/metrics/sprints moved to routers/sprint_analytics.py (issue #1252)
